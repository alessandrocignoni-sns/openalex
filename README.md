...
- **251103_DatiWorksInCSVDaIstituzione.py** - From OpenAlex institution id, it uses the works endopint to gets the data for each of its works, then it writes them in a CSV file containing OpenAlex id, DOI, title and publishing date of each work.
